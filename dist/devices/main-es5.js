...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  "./src/app/app.component.ts": function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "uploadFileEvt",
        value: function uploadFileEvt(e) {
          var _this = this;
          ...
          reader.onload = function (evt) {
            var xmlData = evt.target.result; //  console.log(xmlData);

            _this.parseXML(xmlData).then(function (data) {
              _this.devices = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](data);
              _this.devices.filterPredicate = _this.customFilterPredicate();
            });
          };
        ...
        value: function parseXML(xmlData) {
          return new Promise(function (resolve) {
            ...
            var channels = xmlDoc.getElementsByTagName("Channel"); //console.log(channels);

            if (channels) {
              for (var i = 0; i < channels.length; i++) {
                try {
                  var intervalChannelID = channels[i].children[0]['attributes'][0].nodeValue;
                  var deviceId = intervalChannelID.split(':')[0];
                  var channel = intervalChannelID.split(':')[1];
                  var startTime = channels[i].children[1].childNodes[1].childNodes[1]['attributes'][0].nodeValue;
                  var endTime = channels[i].children[1].childNodes[1].childNodes[1]['attributes'][1].nodeValue;
                  channelsData.push({
        ...
        value: function isAllSelected() {
          ...
          var numRows = this.devices.data.length;
        ...
        value: function masterToggle() {
          ...
          (_this$selection = this.selection).select.apply(_this$selection, _toConsumableArray(this.devices.data));
        }
        ...
        value: function checkboxLabel(row) {
          ...
          return "".concat(this.selection.isSelected(row) ? 'deselect' : 'select', " row ").concat(row.intervalChannelID);
        }
      }, {
        key: "applyFilter",
        ...
        key: "customFilterPredicate",
        value: function customFilterPredicate() {
          var deviceFilterPredicate = function deviceFilterPredicate(data, filter) {
        ...
        value: function exportXML() {
          ...
          this.selection.selected.forEach(function (d) {
          ...
          xmlDoc += '\n\t</Channels>\n\t</MeterReadingDocument>'; // blob text should be in an array

          var fileToExport = new Blob([xmlDoc], {
            type: "text/xml"
          });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"])('fileInput', {
      "static": true
  ...
  "./src/app/app.module.ts": function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatProgressBarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatToolbarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatCheckboxModule"]],
      providers: [],
  ...
  0: function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Projects\Devices\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
